...
class VSKWindow(QMainWindow):
    ...
    def set_as_desktop(self):
        self.setAttribute(Qt.WA_X11NetWmWindowTypeDesktop, True) # Seteo tipo desktop x11
        self.setAttribute(Qt.WA_WA_AlwaysStackOnTop, False) 
        self.setWindowFlags(
            self.windowFlags() | Qt.FramelessWindowHint | Qt.CustomizeWindowHint
        )   